...
public class Flower {
    ...
    public Flower(int id, String commonName, String FlowerFamily, double waterConsumptionPerDay, boolean shadePreferred,
    ...
    public void setFlowerFamily(String FlowerFamily) {
        this.FlowerFamily = FlowerFamily;
    }
